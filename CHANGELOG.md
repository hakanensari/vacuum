...
- Support Login with Amazon (LwA) authentication for v3.x credentials (#103)
...
[Unreleased]: https://github.com/hakanensari/vacuum/compare/v5.1.0...HEAD
[5.1.0]: https://github.com/hakanensari/vacuum/compare/v5.0.0...v5.1.0
